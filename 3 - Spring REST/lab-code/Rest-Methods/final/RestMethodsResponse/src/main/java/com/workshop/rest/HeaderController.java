...
public class HeaderController {
  ...
  // Retrieving collection of all headers using HttpHeaders
  @GetMapping("/header-second")
  public void secondHeader(@RequestHeader HttpHeaders allHeaders) {
    
    logger.info("secondHeader called");
    
    // We can get specific header information with an appropriate getMethod call
  ...
  // Using HttpServletResponse to add a custom header in the response
  ...
  // Using ResponseEntity to add a custom header in the response
  ...
  public ResponseEntity<Object> eigthHeader() {
    ...
    // The created method call explicitly adds a 201 Created response code
