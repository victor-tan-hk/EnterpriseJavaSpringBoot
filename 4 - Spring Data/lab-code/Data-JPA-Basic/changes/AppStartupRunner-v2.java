...
public class AppStartupRunner implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    log.info("Deleting the last 3 records as an example");
    ...
    log.info("Remember to the id must be set to null in each developer object");
    log.info("so Hibernate knows to autogenerate a unique value for id");
    log.info("when persisting developer record to table");
