...
public class RandomRecordGeneratorService {
  ...
  public List<Developer> getRandomDevelopers(int num) {
	...
	/*
	 * It is important to set the id value to null since it is marked as
	 * @GeneratedValue This signals to Hibernate that you're creating a new entity,
	 * and it will generate the ID for you. Otherwise, if you put in some value
	 * here, it will attempt to find the value and if it can't, it will throw an
	 * error message.
	 */      
      Developer randomDev = new Developer(null,name,age,languages,married);
