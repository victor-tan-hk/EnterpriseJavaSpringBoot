...
public interface DeveloperRepository extends PagingAndSortingRepository<Developer, Integer>, CrudRepository<Developer, Integer> {
  ...
  // Find all developers who are married and can code in a specific language
  List<Developer> findByMarriedAndLanguagesContaining(boolean married, String langToFind);
    
  // Find all developers that are younger than a specified age
  List<Developer> findByAgeLessThan(Integer age);

  // Find all developers that are older than a specified age
  List<Developer> findByAgeGreaterThan(Integer age);
